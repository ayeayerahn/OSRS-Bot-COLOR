...
from model import Bot, RuneLiteBot, AaronFunctions
...
class App(customtkinter.CTk):
    ...
    def build_ui(self):  # sourcery skip: merge-list-append, move-assign-in-block
        ...
        for name in names:
            ...
            if obj is not Bot and obj is not RuneLiteBot and obj is not AaronFunctions and isinstance(obj, type) and issubclass(obj, Bot):
                instance = obj()
...
if __name__ == "__main__":
    ...
    #from model.osrs.AaronScripts.anvil_smith import OSRSanvil_smith # Uncomment this line and replace <folder_bot_is_in> and <bot_class_name> accordingly to import your bot
    app = App()  # Add the "test=True" argument to the App constructor call.
    app.start()  # Comment out this line.
    #app.test(OSRSanvil_smith())  # Uncomment this line and replace argument with your bot's instance.
